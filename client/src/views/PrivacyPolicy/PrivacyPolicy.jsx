...
You acknowledge that you are disclosing Personal Information voluntarily. We identify and use your IP address to help diagnose problems with our server, and to administer our Website. Your IP address is also used to help identify you and to gather broad demographic information.
          ...
          <Typography
            ...
            sx={{ mt: 2, textAlign: "justify", textJustify: "inter-word" }}
          >
            Jagriti Yoga & Naturopathy Sansthan operates a strict privacy policy and we are committed to being transparent about how we use cookies on our website.
          </Typography>
          <Typography
            variant="h5"
            sx={{ mt: 2 }}
            ...
            data.map((item, index) => {
              return (
                ...
                >
                  ...
                  <Typography
                    variant="h6"
                    sx={{ml:1,textAlign: "justify", textJustify: "inter-word" }}
                  >
                    {item.title}
                  </Typography>
                </Box>
