  ...
  return (
    <>
      <Box sx={{ zIndex: 2, m: "auto", width: { xs: "100%", md: "80%" }, }}>
        ...
        >
          JAGRITI Yoga & Naturopathy (JYANS) is an autonomous institution for
          Research and Development in Yoga & Naturopathy, established in 2015
          under the Societies Registration Act, 1860. IT is a self funded and
          some projects are funded by Govt. of INDIA. As per the Memorandum of
          Association, the objectives of the Institution are as under:-
        </Typography>
      </Box>
      <Box
        sx={{
